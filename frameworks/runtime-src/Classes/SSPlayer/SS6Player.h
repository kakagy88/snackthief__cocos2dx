...
public:
	...
	*/
    ...
    std::vector<std::string> getAnimeName(const std::string& dataKey, const std::string& packName);
...
public:
	...
	*/
    ...
    void setPartVisibleRecursive(std::string partsname, bool flg);
	...
	*/
    ...
    std::string getPartCellName(std::string partsname);
	...
	*/
    bool changeInstanceAnime(std::string partsname, std::string dataname, std::string animeName, bool overWrite, Instance keyParam);
